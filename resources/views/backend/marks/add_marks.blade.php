                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="float-left">Marks Entry</h3>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('store.marks') }}" method="POST" id="quickForms">
                                @csrf
                                <div class="form-row">
        ...
        $(document).on('click', '#search', function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    var html = '';
                    $.each(data.get_students, function (key , v) {
                        html +=
                            '<tr>'+
                            ...
                            '<td><input type="text" class="form-control form-control-sm" name="other_marks[]"></td>'+
                            '</tr>';
                    });
