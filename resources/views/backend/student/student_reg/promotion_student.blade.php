                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="float-left">Promotion Student</h3>
                            <p class="float-right "><a class="btn btn-info btn-sm" href="{{ route('view.student') }}"><i class="fa fa-list-alt"></i>  Student List</a></p>
                        </div>
                        <div class="card-body">
                            <form id="quickForm" action="{{ route('promotion.student.store',$promotion->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" name="name" id="name" value="{{ $promotion->user->name }}" class="form-control">
                                        <span style="color:red">{{ $errors->has('name') ? $errors->first('name') : '' }}</span>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="fname">Father's Name <font style="color: red">*</font></label>
                                        <input type="text" name="fname" id="fname" value="{{ $promotion->user->fname }}" class="form-control">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" name="mname" id="mname" value="{{ $promotion->user->mname }}" class="form-control">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" name="mobile" id="mobile" value="{{ $promotion->user->mobile }}" class="form-control">
                                        <span style="color:red">{{ $errors->has('mobile') ? $errors->first('mobile') : '' }}</span>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="address">Address <font style="color: red">*</font></label>
                                        <input type="text" name="address" id="address" value="{{ $promotion->user->address }}" class="form-control">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select name="gender" id="gender" class="form-control">
                                            ...
                                            <option {{ $promotion->user->gender == 'Male' ? 'selected' : '' }} value="Male">Male</option>
                                            <option {{ $promotion->user->gender == 'Female' ? 'selected' : '' }} value="Female">Female</option>
                                        </select>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select name="religion" id="religion" class="form-control">
                                            ...
                                            <option {{ $promotion->user->religion == 'Islam' ? 'selected' : '' }} value="Islam">Islam</option>
                                            <option {{ $promotion->user->religion == 'Hindu' ? 'selected' : '' }} value="Hindu">Hindu</option>
                                            <option {{ $promotion->user->religion == 'Other' ? 'selected' : '' }} value="Other">Other</option>
                                        </select>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="date" name="dob" id="dob" value="{{ $promotion->user->dob }}" class="form-control" autocomplete="off">
                                        <span style="color:red">{{ $errors->has('dob') ? $errors->first('dob') : '' }}</span>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="discount">Discount <font style="color: red">*</font></label>
                                        <input type="text" name="discount" id="discount" value="{{ $promotion->discount_student->discount }}" class="form-control">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select name="year_id" id="year_id" class="form-control select2bs4">
                                            ...
                                            @foreach($year as $yr)
                                                <option {{ $promotion->year_id == $yr->id ? 'selected' : '' }} value="{{ $yr->id }}">{{ $yr->name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <select name="class_id" id="class_id" class="form-control select2bs4">
                                            ...
                                            @foreach($class as $cls)
                                                <option {{ $promotion->class_id == $cls->id ? 'selected' : '' }} value="{{ $cls->id }}">{{ $cls->name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group col-md-2" style="float: right">
                                        <img id="showImage" src="{{ $promotion->user->image ? url($promotion->user->image) : asset('public/backend/upload/no_image.png') }}" height="100" width="110">
                                    </div>
                                </div>
