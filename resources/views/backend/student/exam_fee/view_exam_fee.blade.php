                ...
                <div class="col-md-12 ">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="float-left">Exam Fee</h3>
                        </div>
                        <div class="card-body">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-3">
                                    <label for="exam_id">Exam <font style="color: red">*</font></label>
                                    <select name="exam_id" id="exam_id" class="form-control select2bs4">
                                        <option value="">Select Exam</option>
                                        @foreach($exam_type as $ex_type)
                                            <option value="{{ $ex_type->id }}">{{ $ex_type->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group col-md-3">
...
@push('css')
    <script>
        $(document).on('click', '#search', function () {
            ...
            $.ajax({
                url : "{{ route('get.student.exam.fee') }}",
                type : "GET",
