                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="float-left">Add Costs</h3>
                            <p class="float-right "><a class="btn btn-info btn-sm" href="{{ route('view.other.cost') }}"><i class="fa fa-list-alt"></i>  Cost List</a></p>
                        </div>
                        <div class="card-body">
                            <form id="quickForms" action="{{ route('store.other.cost') }}" method="POST" enctype="multipart/form-data" >
                                @csrf
                                <div class="form-row">

                                    <div class="form-group col-md-3">
                                        <label for="date">Date</label>
                                        <input type="text" name="date" id="date" value="{{ old('date') }}" class="form-control" placeholder="Date" autocomplete="off">
