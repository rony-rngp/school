            ...
            <div class="row">
                <div class="col-md-10 offset-1">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="quickForm" action="{{ route('update.user', $user->id) }}" method="POST" enctype="multipart/form-data" >
                                @csrf
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="email" name="email" id="email" value="{{ $user->email }}" class="form-control" placeholder="E-Mail">
