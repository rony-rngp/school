...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-12 text-center">
            <h5 style="font-weight: bold; padding-top: -25px">Result of {{ $all_data[0]->exam_type->name }}</h5>
        </div>
        <div class="col-md-12">
            <table border="0" width="100%" cellpadding="1" cellspacing="2" style="text-align: center">
                <tbody>
                <tr>
                    <td><strong>Session : </strong>{{ $all_data[0]->year->name }}</td>
                    <td></td>
                    <td></td>
                    <td><strong>Class : </strong>{{ $all_data[0]->student_class->name }}</td>
                </tr>
                </tbody>
            </table><hr>
