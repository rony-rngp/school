                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="float-left">Add Notice</h3>
                            <p class="float-right "><a class="btn btn-info btn-sm" href="{{ route('view.notice') }}"><i class="fa fa-list-alt"></i> Notice List</a></p>
                        </div>
                        <div class="card-body">
                            <form id="quickForm" action="{{ route('store.notice') }}" method="POST" enctype="multipart/form-data" >
                                @csrf
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea type="text" rows="4" name="body" id="body" class="form-control">{{ old('body') }}</textarea>
