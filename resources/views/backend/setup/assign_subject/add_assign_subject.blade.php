            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="quickForm" action="{{ route('store.assign.subject') }}" method="POST" enctype="multipart/form-data" >
                                @csrf
                                <div class="add_item">
                                    <div class="form-row">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" name="full_mark[]" id="full_mark" value="{{ old('full_mark') }}" class="form-control" placeholder="Full Mark">
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label for="pass_mark">Pass Mark</label>
                                            <input type="text" name="pass_mark[]" id="pass_mark" value="{{ old('pass_mark') }}" class="form-control" placeholder="Pass Mark">
                                        </div>
